...
export function randomString(length) {
  ...
  let getChunk = function () {
      ...
      for (i = 0; i < 10; i++) str += a[bin[i]][i]; //gets the next character, depends on the bit in the same position as the character - that way it will decide what case to put next
      return str;
    },
