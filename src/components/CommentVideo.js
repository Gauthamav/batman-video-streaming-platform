...
const Comment = ({ data }) => {
  ...
  return (
    <div className=" bg-gray-100 w-full max-w-[40rem]">
      <div className="flex items-center  ">
        <img
          className="w-5 h-5 rounded-3xl mr-2 "
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4vK39mvab0UiMEU0L82eB0gaPb3cUFfMi_A&s"></img>
...
const CommentVideo = () => {
  return (
    <div className="mt-8 ml-6 max-w-full">
